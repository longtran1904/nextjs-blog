    ...
    return (
        <div className="w-60 min-h-screen shadow-md bg-white px-1">
            ...
            <div className="flex items-center justify-center">
                <ul>
                    <li>
                        <a className="flex items-center text-sm py-4 h-12 overflow-hidden text-gray-700 text-ellipsis whitespace-nowrap rounded hover:text-gray-900 hover:bg-gray-100 transition duration-300 ease-in-out" href="#!" data-mdb-ripple="true" data-mdb-ripple-color="dark">
