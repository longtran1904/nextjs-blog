    ...
    return (
        <>
            <div className="group max-w-full p-6 bg-white border-none rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-70 hover:scale-105 transition-all ease-in-out duration-500">
                ...
                <Link href={CardParam} className="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                    Read more
